...
const nextConfig: NextConfig = {
  // 1. Otimização de Imagens (AVIF + WebP)
  // (output: 'standalone' removido — era específico do Cloud Run; o Vercel gerencia o build nativamente)
  images: {
  ...
  // Headers de cache e segurança (suportados nativamente pelo Vercel)
  async headers() {
    return [
      {
